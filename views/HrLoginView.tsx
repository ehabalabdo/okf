...
const HrLoginView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-slate-100 flex items-center justify-center p-4" dir={isAr ? 'rtl' : 'ltr'}>
      <div className="w-full max-w-sm">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-amber-200">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                type="text"
                className="w-full p-3 rounded-xl border border-gray-200 outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 text-sm"
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-amber-500 to-purple-600 text-white py-3 rounded-xl font-extrabold text-sm hover:from-amber-600 hover:to-purple-700 transition-all shadow-lg shadow-amber-200 disabled:opacity-50"
            >
