      ...
      <div className="relative z-10 w-full max-w-md mx-auto bg-slate-900/85 rounded-3xl shadow-2xl border border-slate-700 backdrop-blur-xl p-8 flex flex-col items-center">
        <div className="flex flex-col items-center mb-8">
          <div className="logo-float">
            <img src={client?.logoUrl || "/logo.png"} alt={client?.name || "TKC"} className="h-20 w-20 object-contain" />
          </div>
          <h1 className="text-2xl font-bold text-white mb-1">{client?.name || 'TKC'}</h1>
        ...
        <div className="mt-6 text-xs text-slate-500 text-center">© 2026 TKC</div>
      </div>
